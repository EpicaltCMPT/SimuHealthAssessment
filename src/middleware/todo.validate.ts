...
export function authenticateTodo(req: AuthenticatedTodoRequest, res: Response, next: NextFunction) {
    ...
    try {
        ...
        if (typeof decoded === "string" || !decoded.userId) throw new Error("Invalid token");
